...
import model.BO.CheckDeleteBO;
import model.BO.CheckLoginBO;
import model.BO.CheckUpdateBO;

/**
 * Servlet implementation class CheckDeleteServlet
 */
...
public class CheckDeleteServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CheckDeleteBO checkDeleteBO = new CheckDeleteBO();
		CheckLoginBO checkLoginBO = new CheckLoginBO();
		try {
			if (checkDeleteBO.CheckDeleteStudent(id)) {
